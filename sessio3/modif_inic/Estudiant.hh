...
public:
  ...
  // Cal redefinir operador = per a modificar constructora de copia per defecte
  ...
  /* Pre:  cert */
  /* Post: El resultat es un estudiant nou, copia d'est */
  ...
  /* Pre:  Donats dos estudiants per referencia */
  /* Post: true - si dni del primer es mes petit; false - altrament */
